...
internal class RangeValidator(private val min: Float, private val max: Float) : Validator() {
    ...
    override fun validate(view: View, required: Boolean, errorMessage: String?) {
        ...
        (view as? EditText)?.let {
            ...
            val floatInput = input.toString().toFloatOrNull()
            if (floatInput == null || floatInput < min || floatInput > max) {
    ...
    override fun getErrorMessage(): String {
        return "Should be in between $min and $max"
    }
}